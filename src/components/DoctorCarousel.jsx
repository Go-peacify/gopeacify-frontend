    ...
    <div className='flex w-[90%] m-auto my-20'>
      <div className='w-45% m-auto'>
        <div className='flex flex-col gap-4'>
          ...
          <h6 className='text-5xl font-semibold  inline-block text-transparent bg-clip-text bg-gradient-to-r from-[#45BDBF] to-[#005C7B]'>Qualified Doctors</h6>
          <h6 className='w-[60%] font-medium'>Handled directly by general doctors and professional and experienced specialists doctors.</h6>
        </div>
        <div className='w-full'>
          <div className='relative flex w-[70%]'>
            <img src={images[currentImageIndex].image} className='' alt="Doctor" />
      ...
      <div className='w-[40%] m-auto '>
        <div className='w-[92%] m-auto'>
          <img src={images[currentImageIndex].image} className='w-full' alt="Doctor" />
        </div>
      </div>
    </div>
  );
