        ...
        <div className="flex gap-8 items-center justify-end">
                ...
                >
                  ...
                  >
                    <div className="absolute z-10 w-[140px]  rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                      <p className="text-sm block px-4 py-2 text-[#A4A4A4] "> OUR SERVICES</p>
                      <div className="py-1">
          ...
          <div
                ...
                >
                  ...
                  >
                    <div className="absolute z-10  w-[140px]  rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                      <p className="text-sm block px-4 py-2 text-[#A4A4A4]  " onClick={() => handleClick("issues")}> Issues We Solve</p>
                      <div className="py-1">
                        <a className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900">
                          Depression
                        </a>
          ...
          <div
                ...
                >
                  ...
                  >
                    <div className="absolute z-10  w-[140px]  rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                      <p className="text-sm block px-4 py-2 text-[#A4A4A4]  " onClick={() => handleClick("yoga")}> Exercise we offer</p>
                      <div className="py-1">
                        <a className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" onClick={() => handleClick("yoga")}>  
                          Yoga
                        </a>
                        <a className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900">
                        Meditation
