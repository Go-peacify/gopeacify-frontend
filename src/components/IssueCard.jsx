...
<div className="flex flex-row justify-center items-center  place-items-center">
    <div className=" h-[321px] w-[300px] outline hover:bg-btn hover:shadow-lg hover:shadow-lightcyan border-[#4F4E4E] drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.25))  rounded-[25px] md:mr-10 sm:mr-5 mr-2 my-5 ">
