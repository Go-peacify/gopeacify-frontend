...
const Sadhna = () => {
    ...
    return (
        ...
        <div className="grid grid-cols-2 px-16 py-6 mt-14 mb-12">
          <div className='md:mx-0 my-24 md:my-0 gap-8 md:gap-0 flex flex-col justify-around'>
            <h2 className='text-5xl text-[#3B6377] font-bold sm:text-[4em] text-[4em] w-[70%]'>
              <span className='bg-gradient-to-r from-[#00F5A0] to-[#00D9F5]  bg-clip-text text-transparent font-bold'>Meditation</span>is the best way to improve mental health.</h2>
        ...
        <div className='py-20'>
          ...
          <div className='w-[80%] mx-auto grid grid-cols-4 gap-8 mt-20 '>
