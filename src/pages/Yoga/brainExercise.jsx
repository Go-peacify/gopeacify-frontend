...
import { Flexible, BrainExercisePhoto, EllipseSadhna, Rope, Enneagram, Brain1, Img2, Img3, Img4, Img5, Img6, Img7, Img8 } from '../../assets'
const Sadhna = () => {
    const data = [
        ...
        <div className='text-black'>
            ...
            <div className='w-full flex'>
                ...
                <div className='lg:w-[45%] md:w-[50%] lg:p-16 md:p-6 w-[80%] mx-auto md:mx-0 my-24 md:my-0 gap-8 md:gap-0 flex flex-col justify-around'>
                    <h2 className='text-5xl '><span className='text-lightcyan font-semibold'>Brain Exercises</span> is the best way to improve mental health.</h2>
                ...
                <div className='lg:w-[55%] md:w-[50%] relative md:block hidden  '>
                    ...
                    <img src={BrainExercisePhoto} className='absolute lg:top-0 md:top-[7em] z-20 left-[5em]' />
                </div>
            ...
            <div className='relative '>
                <img src={Brain1} className='w-full' />
