...
export default function Patient_SignIn() {
            ...
            <div className='ml-0 xs:w-[300px] xs:ml-5 xs:mr-auto xs: md:w-[80%]  md:mr-20 md:ml-auto  '>
                ...
                <div className=' left-0 xs:ml-0 xs:mr-auto md:flex md:flex-col md:items-center md:justify-center '>
                    ...
                    <div className='w-[250px] ml-10 md:ml-0 justify-center'>
                            ...
                            <div className='my-6'>
                                <input type="text" id="email" value={email} onChange={(e) => setEmail(e.target.value)} className={` border ${errors.email ? 'border-red-500' : 'border-gray-300'} bg-gray-50 border-b-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`} placeholder='Email Address'/>
                                {errors.email && <p className="text-red-500 text-sm mt-1">{errors.email}</p>}
                            </div>
                            
                            <div className="my-6">
                                <input type="password" id="password"  value={password} onChange={(e) => setPassword(e.target.value)} className={` border ${errors.password ? 'border-red-500' : 'border-gray-300'} bg-gray-50 border-b-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`} placeholder="•••••••••" required/>
...
//             <div className="py-10">
//               <h1 className="xs:text-left xs:ml-0 xs:mr-auto md:text-center">
//                 Create Account
//               </h1>
//             </div>
//             <div>
...
//                   </button>
//                 </div>
//                 <h2 className="text-[#A6A6A6]  text-left mx-32 xs:text-center text-2xl">
//                   -OR-
//                 </h2>
//                 <form onSubmit={handleSubmit}>
...
//                   <button
//                     type="submit"
//                     className="xs:ml-5 ml:auto w-[240px] bg-lightcyan hover:shadow-xl hover:bg-btn text-white border-black justify-center outline-primary rounded-full font-semibold "
//                   >
//                     Create Account
//                   </button>
//                 </form>
