...
import {search, chat, bell, kim, doctor, incline, decline, downarrow, fever, heart, cough, dots } from "../assets";
  ...
  return (
      ...
      <div className='xl:w-[70%] lg:w-[70%] md:w-[70%] sm:w-[45%] xs:w-[75%] flex'>
        ...
        <div className=' w-screen md:w-[30%] flex justify-start my-5 md:my-0  md:justify-end mr=0'>
                    ...
                    <div className='flex flex-row ml-4 border border-black w-[170px] p-2 rounded-3xl'>
                        ...
                        <p className='text-black font-medium ml-2 align-middle text-center py-2'>Dr Kim</p>
                        </div>
                        </div>
                ...
                <div className='w-[60%] ml-10 py-10'>
                  ...
                  <div className=' py-20 flex flex-row gap-10'>
                    <div className='w-[50%] bg-[#D7F1FC] rounded-2xl'>
                      ...
                      <h3 className='font-semibold tracking-wide '>New Patients</h3>
                      <div className='flex flex-row'>
                        ...
                        <div className='w-20 h-6 shadow-md shadow-slate-500  bg-[#DFFDDD] rounded-3xl  flex flex-row'>
                          <div>
                            <h3 className='font-semibold text-center text-[#008000] pl-5'>51%</h3>
                            </div>
                            <div className='justify-end'>
                          <img src={incline} alt="incline" className='h-1/2 my-1' />
                            </div>
                    ...
                    <div className='w-[50%] bg-[#D7F1FC] rounded-2xl'>
                      <div className='ml-5 mt-1'>
                      <h3 className='font-semibold tracking-wide'>Old Patients</h3>
                      <div className='flex flex-row'>
                        <div className='w-[45%]'>
                        <h1>64</h1>
                        </div>  
                        ...
                        <div className='w-20 h-6 shadow-md shadow-slate-500  bg-[#FBC3C3] rounded-3xl  flex flex-row'>
                          <div>
                            <h3 className='font-semibold text-center text-[#D30404] pl-5'>20%</h3>
                            </div>
                            <div className='justify-end'>
                          <img src={decline} alt="incline" className='h-1/2 my-1' />
                            </div>
    ...
    <div className="inline-flex space-x-36 items-center justify-end w-full h-9">
        ...
        <div className="flex space-x-2 items-center justify-end w-20 h-2/3">
            <p className="text-base text-black text-opacity-60">Today</p>
            
              <img src={downarrow} alt="arrow" className='cursor-pointer'></img>            </div>
          </div>
          <div className="inline-flex space-x-24 items-start justify-start w-full">
            <div className="relative flex" >
              <div>
                ...
                <div className="w-12 ml-1 mt-1 h-12 absolute left-0 top-0 bg-green-600 bg-opacity-25 rounded-full">
                  </div>
                  </div>
                  </div>
                  <div className='ml-5'>
    ...
    <div className="flex pl-2  pt-4 pb-5 border rounded-2xl border-blue-400 border-opacity-50" style={{width: 390.19, height: 370.74,}}>
        ...
        <div className="inline-flex ml-5 space-x-24 items-start justify-start w-full">
            <div className="relative  flex" >
              <div>
                ...
                <div className="w-12 ml-1 mt-1 h-12 absolute left-0 top-0 bg-green-600 bg-opacity-25 rounded-full">
                  ...
                  <div className='ml-5'>
            <p className="text-lg font-medium">Demi Joan</p>
            <p className="text-xs text-[#978E8E]">Male - 28 Years 3 Months</p>
            </div>  
            ...
            <div className=" flex flex-col space-y-5 items-start justify-start w-full h-1/2">
                ...
                <div className="ml-5 flex space-x-3 justify-end w-80 h-9">
                    <p className="w-1/4 text-xs font-medium">Last Checked</p>
                    <p className="w-64 text-xs text-black text-opacity-50">Dr Everly on 21 April 2021 Prescription #2J983KT0</p>
                </div>
                <div className="ml-5 flex space-x-3 justify-end w-80 h-9">
                    <p className="w-1/4 text-xs font-medium">Observation</p>
                    <p className="w-64 text-xs text-black text-opacity-50">High fever and cough at normal hemoglobin levels. </p>
                </div>
                <div className="ml-5 flex space-x-3 justify-end w-80 h-9">
                    <p className="w-1/4 text-xs font-medium">Prescription</p>
                    <p className="w-64 text-xs text-black text-opacity-50">Paracetmol - 2 times a day
      ...
      <Calendar  onChange={onChange} value={date} />
          ...
          {/* ---------- */}
            ...
            <h3 href='' className='text-sm base underline underline[#1A71FF] text-[#1A71FF] mt-2'>View All</h3>
            </div>
    ...
    <div className="relative" style={{width: 380.98, height: 120.85,}}>
        <div className="inline-flex space-x-40 items-center justify-between w-96 absolute right-0 bottom-0">
            <p className="text-xl font-bold leading-10 text-gray-800">Upcoming</p>
            <p className="text-xs leading-normal underline text-blue-600">View All</p>
        </div>
            ...
            <div className="flex items-center justify-start flex-1 h-full py-2 pl-3 pr-8 bg-blue-50 rounded-xl">
                <div className="flex space-x-0.5 items-center justify-start flex-1 h-full">
                    ...
                    <div className="inline-flex flex-col space-y-1 items-start justify-end w-64 h-full">
                        <p className="w-full text-base font-medium text-gray-800">Montly doctor’s meet</p>
                        <p className="w-40 text-xs text-black text-opacity-60">8 April, 2021   |   04:00 PM</p>
                    </div>
                </div>
            </div>
        </div>
