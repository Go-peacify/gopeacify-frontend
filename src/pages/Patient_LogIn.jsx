...
// =======
        <div className='flex flex-row'>
            <dhttps://docs.google.com/spreadsheets/u/0/d/1MGVBJ8HkRbCnU6EQASjJKCqQE8BWng4qgL0n3vCVOxE/htmlview#iv className='md:flex md:flex-col md:w-full md:justify-center md:items-center  md:place-items-center bg-white'>
                <div className='flex flex-col justify-center items-center'>
