        ...
        <div className='flex flex-row'>
            <div className='md:flex md:flex-col md:w-full md:justify-center md:items-center  md:place-items-center bg-white'>
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <button type="button" className="xs:ml-5 ml:auto  ml-10 mb-5 md:ml-0 tracking-widest w-[338px] h-[50px] bg-lightcyan hover:shadow-xl hover:bg-btn text-white border-black justify-center outline-primary rounded-xl font-semibold ">
                        LOGIN
                    </button>
                </div>
            </div>
