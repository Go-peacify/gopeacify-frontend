...
const transcedentalMeditation = () => {
    return (
        <div className="TranscedentalMeditation">
            <div className="trans">
            ...
            <div className="fifthLayer">
                ...
                <div className="text2">
                    <span>This smart mat will teach you yoga and also help get
                        correct</span>
                </div>
                <div className="text3">
...
export default transcedentalMeditation